...
[Docs](https://docs.rs/serde_closure/0.2.1)
 ...
 * There are three macros,
   [`FnOnce`](https://docs.rs/serde_closure/0.2.1/serde_closure/macro.FnOnce.html),
   [`FnMut`](https://docs.rs/serde_closure/0.2.1/serde_closure/macro.FnMut.html)
   and [`Fn`](https://docs.rs/serde_closure/0.2.1/serde_closure/macro.Fn.html),
